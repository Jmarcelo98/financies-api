...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private final String[] ACESS_PUBLIC_CONTROLLERS = { "/users" };
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers(HttpMethod.POST, "/login").permitAll()
				.antMatchers(HttpMethod.POST, ACESS_PUBLIC_CONTROLLERS).permitAll().antMatchers(ACESS).permitAll()
				.anyRequest().authenticated().and().addFilter(new JWTAuthenticateFilter(authenticationManager()))
